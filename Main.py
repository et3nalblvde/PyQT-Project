...
class FilmDetailsWindow(QtWidgets.QDialog):
    ...
    def edit_movie(self, title, year, rating, film_link, poster_link, description, genre):
        ...
        genre_input = QtWidgets.QLineEdit(genre)
        genre_input.setPlaceholderText("Жанр")
        genre_input.setFixedHeight(40)
        genre_input.setStyleSheet(
            "background-color: white; border: 1px solid #4169E1; border-radius: 5px; padding: 10px;")
        ...
        save_button.clicked.connect(
            lambda: self.save_changes(title_input.text(), year_input.text(), rating_input.text(), genre_input.text(),
